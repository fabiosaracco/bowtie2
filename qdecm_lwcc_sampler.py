...
def main():
    ...
    for i in range(len(files)//2):
        ...
        for d in dicos:
            ...
            pvalue_lwcc_filename=PVALUE_FOLDER+f'{dataset_name}_dico{d}_pvalues_lwcc.pkl'
            ...
            #    continue
            counter=0
            while os.path.exists(pvalue_lwcc_filename):
                pvalue_lwcc_filename=PVALUE_FOLDER+f'{dataset_name}_dico{d}_pvalues_lwcc_{counter}.pkl'
                counter+=1
